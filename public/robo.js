...
let raio = none, velocidadeMaxima = none, tempofinal = none;
...
function vetor() {
    ...
    alert("X: " + vetRoboX[0]);
    alert("Y: " + vetRoboY[0]);
    let distBolaRobo = document.getElementById("resultado");
    ...
    for (i = 0; i < 1002; i++) {
        ...
        if (vetRoboX[i] >= vetX[i] - 0.125 && vetRoboX[i] <= vetX[i] + 0.125 && vetRoboY[i] >= vetY[i] - 0.125 && vetRoboY[i] <= vetY[i] + 0.125) { //hitbox - range de 0.125
            ...
            for (c=0;c<1002;c++){
                ...
                if(tempFinal[c] === tempfinal){ // Alterei o ==
                    break;
                }
            }
...
function cv(){
    ...
    function desenha() {
        ...
        let robozin = new Image();
        robozin.src='robozin.png';
        ctx.drawImage(robozin, robozinX,robozinY, 36, 30);
